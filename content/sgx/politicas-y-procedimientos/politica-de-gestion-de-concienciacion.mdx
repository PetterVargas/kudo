...
Se ejecutará un plan de comunicaciones periódico con mensajes cortos sobre riesgos vigentes y buenas prácticas, distribuido por los canales internos de la organización.

### Campañas de Phishing
Se realizarán simulaciones periódicas de phishing para medir la exposición del personal, con retroalimentación inmediata y capacitación de refuerzo para quienes interactúen con la simulación.

### Reonboarding
Colaboradores que cambian de rol, se reincorporan tras una ausencia prolongada, o presentan resultados deficientes en evaluaciones o campañas, serán incluidos en un proceso de reonboarding que refuerce las prácticas de seguridad esperadas.

### Validación de Cumplimiento
Cada colaborador y cada líder de área validarán, mediante checklists periódicos, el cumplimiento de las capacitaciones, campañas y responsabilidades individuales y de equipo definidas por el Programa de Concienciación.
