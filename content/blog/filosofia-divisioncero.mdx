...
description: "Por qué construimos DivisionCero: tecnología digna de confianza, código abierto y una ciberseguridad más colaborativa, accesible y humana."
author: Peter Vargas
date: 2025-01-03
categories: 
  - divisioncero
...
Construyamos tecnología que sea *digna de confianza* — no solo diseñada para funcionar o para dificultar los ataques.
...
Mantengámonos unidos contra el *ego en la ciberseguridad* que nos ha afectado a todos, a menudo llevando a la creación de *marcos, estándares, referencias y directrices redundantes* — cada uno centrado en su propia visión, sin realmente apuntar a co-crear, unificar o aportar a un mundo con personas u organizaciones menos atacadas.
